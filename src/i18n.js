const STRINGS = {
  en: {
    ...
    model_count_truncated: '{shown} of {total} models',
    grid_truncated: 'Showing the first {shown} of {total} models. Use search or pick a category on the left to narrow down.',
    tree_all: 'All',
    tree_fav: '⭐ Favorites',
    anim_chip: '▶ Anim',
  ...
  zh: {
    ...
    no_models: '沒有符合的模型',
    model_count: '{n} 個模型',
    model_count_truncated: '{shown} / 共 {total} 個模型',
    grid_truncated: '顯示前 {shown} 個（共 {total} 個）。請用搜尋或選擇左側分類縮小範圍。',
    tree_all: '全部',
    tree_fav: '⭐ 最愛',
    anim_chip: '▶ 動畫',
